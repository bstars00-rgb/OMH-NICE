...
function seed(){
  ...
  const c11 = mk({ id:'C011', name:B('Travelata (RU · UAE 계약법인)','Travelata (RU · UAE contracting entity)'), country:B('러시아(모스크바) · UAE 계약법인','Russia (Moscow) · UAE contracting entity'), businessType:'OTA(B2C)',
    ...
    website:B('travelata.ru','travelata.ru'), bizRegNo:B('Travel Technology LLC(ООО Тревел Технологии, 2011) · OMH 계약은 UAE 법인 별도','Travel Technology LLC (2011) · OMH contract via a separate UAE entity'), foundedYear:2011, representative:B('미확인(확인필요)','Unverified (TBC)'),
    ...
    scores:[3,4,4,4,4,2,3,2,2,4,3,1,3,3], status:'review',
    docs:{bizLicense:'notSubmitted',profile:'submitted',bank:'notSubmitted',contract:'notSubmitted',settleAgree:'notSubmitted',refs:'notSubmitted',financials:'notSubmitted',repId:'notSubmitted'},
    public:{website:'Y',linkedin:'unknown',google:'Y',negNews:'N',lawsuit:'N',tradeRefs:'unknown',domainAge:'unknown',addrExists:'Y',repHistory:'unknown'},
    documents:[],
    notes:{expect:B('러시아 대형 온라인 여행사(OTA) Travelata — 운영사 Travel Technology LLC(ООО Тревел Технологии, 2011 설립, 모스크바). 패키지(항공+호텔+트랜스퍼+식사+보험) 비교·예약 마켓플레이스, 기술 중심 B2C. 러시아 아웃바운드 수요를 베트남(1순위)·태국·한국·싱가포르로 → OMH 아시아 호텔의 신규 러시아 B2C 채널. Direct API(Travelata가 개발), 초기 5~10건/일(월 150~300건) 성장 목표.','Large Russian OTA Travelata — operator Travel Technology LLC (founded 2011, Moscow). Package-holiday (air+hotel+transfer+meals+insurance) comparison·booking marketplace, tech-driven B2C. Channels Russian outbound demand to Vietnam(1st)·Thailand·Korea·Singapore → a new Russian B2C channel for OMH Asia hotels. Direct API (Travelata builds it), starting 5-10 bookings/day (150-300/month), growing.'),
      check:B('★★국가 리스크(러시아 국제 제재) — USD 결제·은행·컴플라이언스 이슈로 계약 전 반드시 법무·제재 검토 필요. 계약 주체가 UAE 법인(OMH SG 본사와 계약) ≠ 실제 운영 러시아(Travelata) → UAE 법인 실체·책임·보증 확인 필수. 신용 1:4($10k Deposit로 $40k 한도) → 무담보 노출 $30k. 사업자등록증·UAE 법인 등기·대표자 미확인. 예상 GMV(건당 단가) 미확정.','★★Country risk (Russia international sanctions) — legal·sanctions review required before contracting due to USD payment·banking·compliance. Contracting entity is a UAE company (contracts with OMH SG HQ) ≠ actual operator in Russia (Travelata) → verify UAE entity, liability and guarantee. Credit 1:4 ($10k deposit for $40k limit) → $30k uncovered exposure. Business license·UAE registration·representative unverified. Expected GMV (per-booking value) TBC.'),
      opinion:B('회사(2011 OTA)·러시아 수요·API는 매력적이나, 러시아 제재·계약주체(UAE)·신용노출이 핵심 리스크 → 추가 확인(C). 승인 전제: ①법무/제재 컴플라이언스 검토(USD·은행 경로) ②UAE 계약법인 실체·보증 확인 ③신용 1:4 축소 또는 Deposit 상향(점수 기준 $30k/1주 권장) ④사업자등록증·대표자 확보. 통과 시 소액 파일럿.','The company (2011 OTA)·Russian demand·API are attractive, but Russia sanctions·UAE contracting party·credit exposure are core risks → needs review (C). Approval preconditions: (1) legal/sanctions compliance review (USD·banking route), (2) verify UAE contracting entity·guarantee, (3) reduce 1:4 credit or raise deposit (policy recommends $30k/1wk), (4) obtain business license·representative. If cleared, a small pilot.'),
      comment:B('러시아 OTA로 수요는 있으나 제재·계약주체·신용노출로 신중(3/5). 법무 검토·UAE 법인 확인·Deposit/신용 조건 조정 후 판단.','Russian OTA with real demand, but cautious (3/5) due to sanctions·contracting party·credit exposure. Decide after legal review·UAE entity check·deposit/credit adjustment.')},
