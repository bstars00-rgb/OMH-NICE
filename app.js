...
function seed(){
  ...
  const c11 = mk({ id:'C011', name:B('Travelata (RU · UAE 계약법인)','Travelata (RU · UAE contracting entity)'), country:B('러시아(모스크바) · UAE 계약법인','Russia (Moscow) · UAE contracting entity'), businessType:'OTA(B2C)',
    ...
    scores:[3,4,4,4,4,2,3,2,2,4,3,2,3,3], status:'review',
    ...
    notes:{expect:B('러시아 대형 OTA Travelata — 운영사 Travel Technology LLC(2011, 모스크바). 패키지 비교·예약 B2C. 러시아 아웃바운드를 베트남(1)·태국·한국·싱가포르로 → OMH 아시아 호텔의 신규 러시아 채널. [계약 주체] UAE 법인 Vivatech Platform L.L.C-FZ(두바이 Meydan Free Zone, License 2643677.01, TRN 105369350100001, 2026.1 설립, 이사·100% 단독주주 Alexey Zaretsky·이스라엘 국적, Emirates Islamic Bank USD 계좌 보유). Direct API(Travelata 개발), 초기 5~10건/일.','Large Russian OTA Travelata — operator Travel Technology LLC (2011, Moscow). Package comparison·booking B2C. Channels Russian outbound to Vietnam(1)·Thailand·Korea·Singapore → a new Russian channel for OMH Asia hotels. [Contracting entity] UAE company Vivatech Platform L.L.C-FZ (Dubai Meydan Free Zone, License 2643677.01, TRN 105369350100001, est. Jan 2026, director·100% sole shareholder Alexey Zaretsky·Israeli, Emirates Islamic Bank USD account). Direct API (Travelata builds), 5-10 bookings/day at start.'),
      check:B('★지분관계 확인 결과: UAE 계약법인 Vivatech은 Travelata(RU)와 자본상 무관 — 지분등록부상 개인 Alexey Zaretsky(이스라엘) 100% 단독 소유. 즉 OMH 계약 상대는 Travelata와 지분관계 없는 2026.1 설립 신설 프리존 법인 → Travelata 실적·지급에 대한 직접 recourse·보증 부재. Alexey Zaretsky↔Travelata 관계 및 운영주체 보증 확인 필수. ★러시아 제재: UAE(Emirates Islamic Bank) USD 결제로 경로는 개선됐으나 실운영이 러시아 Travelata → 제재·평판 법무 검토 여전히 필요. 신설 법인·자본 AED 10만(~$27k) 얇음. 신용 1:4($10k→$40k) 무담보 $30k.','★Ownership check: the UAE contracting entity Vivatech has NO capital link to Travelata (RU) — share register shows individual Alexey Zaretsky (Israeli) as 100% sole owner. So OMH would contract with a Jan-2026 new free-zone company unrelated to Travelata → no direct recourse·guarantee for Travelata performance·payment. Must confirm the Alexey Zaretsky↔Travelata relationship and an operator guarantee. ★Russia sanctions: UAE (Emirates Islamic Bank) USD settlement improves the route, but the actual operator is Russia-based Travelata → sanctions·reputation legal review still required. New entity, thin capital AED 100k (~$27k). Credit 1:4 ($10k→$40k) = $30k uncovered.'),
      opinion:B('요청 서류(UAE Trade License·지분등록부·회사소개서)로 UAE 법인·은행·이사 확인(진전). 다만 Travelata와 지분관계 없는 개인 소유 신설 shell이라 recourse·보증이 핵심 관건 → 추가 확인(C) 유지. 승인 전제: ①Alexey Zaretsky↔Travelata 관계·보증 확인 ②법무/제재 검토(운영주체 러시아) ③신용 1:4 축소·Deposit 상향(점수 기준 $30k/1주 권장) ④소액 파일럿.','Requested docs (UAE Trade License·share register·profile) confirm the UAE entity·bank·director (progress). But it is an individually-owned new shell with no ownership link to Travelata → recourse·guarantee is the key issue → stays needs-review (C). Preconditions: (1) confirm Alexey Zaretsky↔Travelata relationship·guarantee, (2) legal/sanctions review (Russia operator), (3) reduce 1:4 credit·raise deposit (policy $30k/1wk), (4) small pilot.'),
      comment:B('UAE 법인·UAE 은행·이사 확인은 진전이나 Travelata와 지분관계 無(개인 신설 shell) → recourse 약함, 신중(3/5). 보증·법무 검토 후 판단.','UAE entity·bank·director confirmed (progress), but no ownership link to Travelata (individual new shell) → weak recourse, cautious (3/5). Decide after guarantee·legal review.')},
