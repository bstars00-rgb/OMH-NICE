...
function seed(){
  ...
  const c6 = mk({ id:'C006', name:B('小云智能 (Xiaoyun AI · 샤오윈 AI)','Xiaoyun AI (小云智能)'), country:B('중국','China'), businessType:B('B2B/OTA(플랫폼)','B2B/OTA (platform)'),
    ...
    website:B('www.yundijie.com (云滴解 Yundijie · 구 黄包车 기반)','www.yundijie.com (Yundijie · ex-Huangbaoche)'), bizRegNo:B('미확인(확인필요) — 온보딩 시 사업자등록증·회사 포트폴리오 제공 예정','Unverified (TBC) — business license·portfolio to be provided at onboarding'), foundedYear:'', representative:B('HE PENG(贺鹏), 단독이사 — Wingpulse(C003)와 동일 대표(특수관계 확인 필요)','HE PENG(贺鹏), sole director — same as Wingpulse (C003); related-party check needed'),
    ...
    history:[
      ...
      {stage:'scm',reviewer:'Global OPs',decision:'hold',comment:B('대표자 확인: HE PENG(贺鹏), 단독이사 — Wingpulse(C003)와 동일 대표. 특수관계·익스포저 집중 리스크 → 두 건 연계 검토, 실사 서류 확보 후 판단.','Representative confirmed: HE PENG(贺鹏), sole director — same as Wingpulse (C003). Related-party·concentration risk → review the two jointly; decide after due-diligence docs.'),date:'2026-07-14'}] });
